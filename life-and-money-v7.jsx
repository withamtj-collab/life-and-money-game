...
const INTERESTS=[{id:"creative",l:"Creative & Arts",i:"🎨",d:"Design, music, writing"},{id:"tech",l:"Technology",i:"💻",d:"Coding, engineering, data"},{id:"people",l:"People & Service",i:"🤝",d:"Teaching, counseling, social work"},{id:"business",l:"Business & Finance",i:"📊",d:"Management, marketing"},{id:"science",l:"Science & Research",i:"🔬",d:"Biology, chemistry, environment"},{id:"trades",l:"Skilled Trades",i:"🔧",d:"Electrical, plumbing, construction"},{id:"law",l:"Law & Government",i:"⚖️",d:"Legal, policy, public service"},{id:"health",l:"Health & Wellness",i:"🏥",d:"Medicine, nursing, therapy"},{id:"media",l:"Media & Comms",i:"📱",d:"Journalism, PR, social media"},{id:"education",l:"Education",i:"📚",d:"Teaching, training, curriculum"}];
const MOTIVATIONS=[{id:"money",l:"High Earning",i:"💰"},{id:"impact",l:"Making a Difference",i:"🌍"},{id:"balance",l:"Work-Life Balance",i:"⚖️"},{id:"passion",l:"Follow Passion",i:"❤️"},{id:"security",l:"Job Security",i:"🛡️"},{id:"growth",l:"Career Growth",i:"📈"}];
const EP=[
...
{id:"community",t:"Community College → Transfer",cost:50000,mo:500,dur:"4 yrs (2+2)",sm:.95,d:"Start at CC, transfer for bachelor's.",pros:["Same degree, 50%+ less debt","Small classes","Work while studying","Explore cheaply"],cons:["$50K debt","May miss campus life","Transfer complexity","Some employer bias"]},
...
{id:"military",t:"Military → GI Bill",cost:0,mo:0,dur:"4+ yrs service",sm:.92,d:"Serve, then free college via GI Bill.",pros:["Zero debt","Free college after","Veteran preference","Leadership skills"],cons:["4+ year commitment","Risk & sacrifice","Delayed career","Tough transition"]},
...
const IO=[
{id:"sp500",n:"S&P 500 Index",risk:"Medium",ar:.10,vol:.16,i:"📈",d:"500 largest US companies"},
{id:"bonds",n:"US Bond Fund",risk:"Low",ar:.04,vol:.04,i:"🏛️",d:"Government & corporate bonds"},
{id:"growth",n:"Growth Tech",risk:"High",ar:.14,vol:.25,i:"🚀",d:"High-growth tech stocks"},
{id:"reit",n:"Real Estate REIT",risk:"Medium",ar:.08,vol:.12,i:"🏘️",d:"Real estate trusts"},
{id:"intl",n:"International",risk:"Med-High",ar:.09,vol:.18,i:"🌍",d:"Non-US companies"},
{id:"hysa",n:"High-Yield Savings",risk:"Very Low",ar:.045,vol:.005,i:"🏦",d:"FDIC insured, safe"}];
const LEP={pos:[{t:"Holiday bonus!",a:2500},{t:"Tax refund!",a:1800},{t:"Side hustle paid off!",a:1200}],neg:[{t:"Car transmission failed",a:-2800},{t:"ER visit — medical bill",a:-3200},{t:"Roof leak — emergency!",a:-4500},{t:"Identity theft fees",a:-1500},{t:"IRS tax bill",a:-1200},{t:"Pet emergency surgery",a:-2000}],neu:[{t:"Friend's destination wedding",a:-800},{t:"Car insurance increase",a:-400},{t:"New tires needed",a:-600}]};
const LIFE_ERA={
era1:{yrs:4,age:22,label:"College Years (4 years)",events:[
{t:"Laptop died — had to replace",a:-900,icon:"💻"},{t:"Scholarship award!",a:2000,icon:"🎓"},{t:"Car accident — deductible",a:-1000,icon:"🚗"},{t:"Summer internship bonus",a:1500,icon:"💼"},{t:"Parking tickets piled up",a:-400,icon:"🅿️"},{t:"Won campus competition!",a:500,icon:"🏆"},{t:"Phone screen shattered",a:-300,icon:"📱"},{t:"Birthday money from family",a:250,icon:"🎂"}]},
era2:{yrs:5,age:27,label:"Early Career (5 years)",events:[
{t:"Performance bonus!",a:3000,icon:"⭐"},{t:"Car transmission failed",a:-2800,icon:"🔧"},{t:"ER visit — no fun",a:-3200,icon:"🏥"},{t:"Side hustle income",a:2000,icon:"💰"},{t:"Speeding ticket + insurance hike",a:-800,icon:"🚨"},{t:"Friend's wedding trip",a:-1200,icon:"✈️"},{t:"Tax refund!",a:1800,icon:"📋"},{t:"New tires + brakes",a:-900,icon:"🚗"},{t:"Got a certification bonus",a:1500,icon:"📜"},{t:"Identity theft fees",a:-1500,icon:"🔓"}]},
era3:{yrs:11,age:38,label:"Building Wealth (11 years)",events:[
{t:"Promotion + raise!",a:8000,icon:"📈"},{t:"Roof replacement",a:-6500,icon:"🏚️"},{t:"New baby expenses",a:-4000,icon:"👶"},{t:"Inheritance from relative",a:10000,icon:"🏛️"},{t:"HVAC system died",a:-5000,icon:"❄️"},{t:"Refinanced at lower rate — savings",a:3000,icon:"🏦"},{t:"Kid's braces",a:-3500,icon:"😁"},{t:"Stock market dip — portfolio lost",a:-5000,icon:"📉"},{t:"Home value increased — equity gain",a:12000,icon:"🏠"},{t:"Medical procedure copay",a:-2500,icon:"💊"},{t:"Annual bonus streak",a:6000,icon:"🎯"},{t:"Car totaled — deductible + replacement",a:-4500,icon:"💥"},{t:"Pet emergency surgery",a:-2000,icon:"🐕"},{t:"Freelance project income",a:3500,icon:"💻"}]}
};
// Shared UI
...
<button onClick={()=>sStep(2)} style={{...bp,background:"linear-gradient(135deg,#fbbf24,#f59e0b)",color:C.dk,fontSize:14,padding:"12px 28px"}}>See What Happened →</button>
</div></Fd></Ph>;
...
<button onClick={revealEvent} style={{...bp,background:"linear-gradient(135deg,#fbbf24,#f59e0b)",color:C.dk,fontSize:14,padding:"12px 28px"}}>Reveal →</button>
</>:<>
<div style={{fontSize:48,marginBottom:6}}>{ev.icon||"📋"}</div>
...
<button onClick={nextEvent} style={{...bp,marginTop:14,fontSize:13}}>{evtIdx+1<evts.length?"Next Event →":"See Summary →"}</button>
</>}
</div></Fd></Ph>}
...
<div style={{textAlign:"center",marginBottom:16}}><div style={{fontSize:44}}>📊</div><h2 style={{fontFamily:F.d,fontSize:22,margin:"6px 0 2px"}}>{era.yrs}-Year Financial Summary</h2><p style={{color:"#80cbc4",fontSize:12}}>Age {era.age-era.yrs} → {era.age}</p></div>

<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(140px,1fr))",gap:8,marginBottom:14}}>
{savAccum>0&&<div style={{background:"rgba(255,255,255,.08)",borderRadius:10,padding:12,textAlign:"center"}}><div style={{fontSize:9,color:"#90a4ae"}}>🛡️ Emergency Saved</div><div style={{fontSize:16,fontWeight:800,color:"#42a5f5"}}>{fmt(Math.round(savAccum))}</div><div style={{fontSize:9,color:"#64b5f6"}}>{fD(moSave)}/mo × {era.yrs}yr</div></div>}
{moInv>0&&<div style={{background:"rgba(255,255,255,.08)",borderRadius:10,padding:12,textAlign:"center"}}><div style={{fontSize:9,color:"#90a4ae"}}>📈 Investments Grown</div><div style={{fontSize:16,fontWeight:800,color:"#ab47bc"}}>{fmt(Math.round(invGrowth))}</div><div style={{fontSize:9,color:"#ce93d8"}}>{fD(moInv)}/mo + growth</div></div>}
{retMo>0&&<div style={{background:"rgba(255,255,255,.08)",borderRadius:10,padding:12,textAlign:"center"}}><div style={{fontSize:9,color:"#90a4ae"}}>🏦 401(k) Growth</div><div style={{fontSize:16,fontWeight:800,color:"#66bb6a"}}>{fmt(Math.round(retGrowth))}</div><div style={{fontSize:9,color:"#81c784"}}>{fD(retMo)}/mo + compound</div></div>}
{debtPaid>0&&<div style={{background:"rgba(255,255,255,.08)",borderRadius:10,padding:12,textAlign:"center"}}><div style={{fontSize:9,color:"#90a4ae"}}>💳 Debt Paid Off</div><div style={{fontSize:16,fontWeight:800,color:"#fbbf24"}}>{fmt(Math.round(debtPaid))}</div><div style={{fontSize:9,color:"#fdd835"}}>{pd.debt-debtPaid<=0?"✅ Debt free!":fmt(pd.debt-debtPaid)+" left"}</div></div>}
<div style={{background:"rgba(255,255,255,.08)",borderRadius:10,padding:12,textAlign:"center"}}><div style={{fontSize:9,color:"#90a4ae"}}>🎲 Life Events Impact</div><div style={{fontSize:16,fontWeight:800,color:evtTotal>=0?"#66bb6a":"#ef5350"}}>{evtTotal>=0?"+":""}{fmt(evtTotal)}</div><div style={{fontSize:9,color:"#90a4ae"}}>{evts.length} events</div></div>
</div>
...
<div style={{textAlign:"center"}}><button onClick={()=>{finalize();onCont()}} style={{...bp,background:"linear-gradient(135deg,#fbbf24,#f59e0b)",color:C.dk,fontSize:15,padding:"12px 32px"}}>Continue Journey →</button></div>
</div></Fd></Ph>}

return null}

// PHASE: Welcome
function Welcome({onStart,onTeacher}){const[sh,sSh]=useState(false);useEffect(()=>{setTimeout(()=>sSh(true),80)},[]);return<div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"linear-gradient(160deg,#0a0e27,#1a2744 40%,#0a3d2e)",fontFamily:F.b,padding:24,opacity:sh?1:0,transition:"opacity .7s"}}><div style={{fontSize:60,marginBottom:10}}>💸</div><h1 style={{fontFamily:F.d,fontSize:"clamp(36px,6vw,56px)",fontWeight:900,color:"#e8f5e9",textAlign:"center",margin:0,lineHeight:1.05}}>Life & Money</h1><p style={{color:"#80cbc4",fontSize:16,textAlign:"center",maxWidth:520,margin:"12px 0 32px",lineHeight:1.5}}>Navigate 20 years of financial decisions — education, careers, housing, investing, and retirement.</p><div style={{display:"flex",gap:12,flexWrap:"wrap",justifyContent:"center"}}><button onClick={onStart} style={{...bp,padding:"13px 30px",fontSize:15}}>🎮 Start Journey</button><button onClick={onTeacher} style={{...bs,background:"rgba(255,255,255,.08)",color:"#a5d6a7",borderColor:"rgba(255,255,255,.15)"}}>🍎 Teacher Dashboard</button></div></div>}
// PHASE: Interests
...
return<Ph title="Who Are You?" sub="Discover what drives you — this shapes career matches.">
...
<div style={{marginTop:18,display:"flex",justifyContent:"flex-end"}}><button onClick={nx} disabled={dis} style={{...bp,opacity:dis?.4:1}}>{step===2?"Continue →":"Next →"}</button></div></Ph>}
...
return<Ph title="Education Decision" sub="Choose wisely — this shapes your debt and career options.">
...
{showPC&&(()=>{const p=EP.find(x=>x.id===sel);return<div style={{background:"#f8f7f4",borderRadius:12,padding:14,marginBottom:10,display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><div><h4 style={{color:C.g,margin:"0 0 5px",fontSize:12}}>✅ Pros</h4>{p.pros.map((x,i)=><div key={i} style={{fontSize:11,color:C.t,padding:"1px 0"}}>• {x}</div>)}</div><div><h4 style={{color:C.r,margin:"0 0 5px",fontSize:12}}>❌ Cons</h4>{p.cons.map((x,i)=><div key={i} style={{fontSize:11,color:C.t,padding:"1px 0"}}>• {x}</div>)}</div></div>})()}
<IB c="y" icon="💡" title="Total Debt Cost">{(()=>{const p=EP.find(x=>x.id===sel);const tot=p.mo*120;return tot>0?`${fmt(p.mo)}/mo × 10 years = ${fmt(tot)} total — ${fmt(tot-p.cost)} is interest!`:"Zero debt = every dollar builds your future."})()}</IB></Fd>}
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} disabled={!sel} style={{...bp,opacity:sel?1:.4}}>Lock Choice →</button></div></Ph>}
...
<div style={{background:"#1e293b",borderRadius:10,padding:12}}><div style={{fontSize:9,color:"#78909c",marginBottom:7,fontWeight:700,textTransform:"uppercase",letterSpacing:1}}>Deductions — click to learn</div>
{ds.map((d,i)=><button key={i} onClick={()=>sRv(rv===i+1?0:i+1)} style={{display:"block",width:"100%",background:rv===i+1?"#334155":"transparent",border:"none",borderBottom:i<ds.length-1?"1px solid #334155":"none",padding:"8px 6px",cursor:"pointer",textAlign:"left",fontFamily:F.b,borderRadius:rv===i+1?6:0}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{display:"flex",alignItems:"center",gap:6}}><div style={{width:7,height:7,borderRadius:"50%",background:d.c}}/><span style={{color:"#e2e8f0",fontSize:12}}>{d.l}</span></div><span style={{color:"#ef5350",fontWeight:700,fontSize:12}}>−{fD(d.v)}</span></div>{rv===i+1&&<div style={{color:"#90a4ae",fontSize:10,marginTop:2,marginLeft:14}}>💡 {d.d}</div>}</button>)}
<div style={{display:"flex",justifyContent:"space-between",borderTop:"2px solid #455a64",paddingTop:7,marginTop:4}}><span style={{color:"#90a4ae",fontWeight:700,fontSize:12}}>Total</span><span style={{color:"#ef5350",fontWeight:800,fontSize:13}}>−{fD(s.td)}</span></div></div>
...
<IB c="y" icon="🤯" title="Reality Check">Your {fmt(pd.salary)} salary = <strong>{fD(s.net)}/month</strong> take-home ({fD(s.net*12)}/year).</IB>
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={onDone} style={bp}>Build Budget →</button></div></Ph>}
// PHASE: Budget — savings split into retirement/emergency/investments, live paystub below
...
const cats=[
...(pd.mortPay?[]:[{k:"housing",l:"🏠 Rent",r:"~28%",c:"#1565c0"}]),
{k:"food",l:"🍎 Food",r:"$300-500",c:"#f9a825"},
{k:"transport",l:"🚗 Transport",r:"$200-400",c:"#6a1b9a"},
{k:"util",l:"💡 Utilities",r:"$100-200",c:"#00838f"},
{k:"phone",l:"📱 Phone",r:"$60-100",c:"#c2185b"},
{k:"fun",l:"🎬 Fun",r:"$50-150",c:"#e65100"},
{k:"clothes",l:"👕 Clothes",r:"$30-80",c:"#00897b"},
{k:"emergFund",l:"🛡️ Emergency Fund",r:"3-6mo goal",c:"#0277bd"},
{k:"investing",l:"📈 Investments",r:"5-15%",c:"#7b1fa2"}];
...
<div style={{fontSize:12,fontWeight:700,color:C.dk,marginBottom:8}}>📌 Fixed Monthly Costs (auto-deducted)</div>
...
<div style={{fontSize:11,color:C.tl,marginTop:4}}>Total fixed: {fD(fixed)}/mo → {fD(af)} remaining</div>
</div>}

<div style={{background:C.card,borderRadius:14,padding:16,marginBottom:14,border:`2px solid ${C.g}`}}>
<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
<div style={{fontSize:13,fontWeight:700,color:C.dk}}>🏦 Retirement (401k) — Pre-Tax</div>
...
<div style={{fontSize:10,color:C.m,marginTop:2}}>💡 Pre-tax = reduces taxable income. Higher % = more retirement but less take-home.</div>
</div>
...
<div style={{background:rm>=0?C.gl:C.rl,borderRadius:12,padding:14,border:`2px solid ${rm>=0?"#66bb6a":"#ef5350"}`,marginBottom:14,textAlign:"center"}}><div style={{fontSize:11,color:C.tl}}>Remaining</div><div style={{fontSize:28,fontWeight:800,color:rm>=0?C.g:C.r,fontFamily:F.d}}>{fD(rm)}</div>{rm<0&&<div style={{color:C.r,fontSize:11}}>⚠️ Over budget!</div>}</div>

<div style={{background:"#f8f7f4",borderRadius:14,padding:14,marginBottom:14,border:`1px solid ${C.br}`}}>
<div style={{fontSize:12,fontWeight:700,color:C.dk,marginBottom:8}}>📊 Savings Breakdown</div>
<div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
<div style={{textAlign:"center",background:C.gl,borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#1b5e20",fontWeight:700}}>🏦 RETIREMENT</div><div style={{fontSize:16,fontWeight:800,color:C.g}}>{fD(s.r4)}</div><div style={{fontSize:9,color:C.tl}}>Pre-tax {retPct}%</div></div>
<div style={{textAlign:"center",background:C.bl,borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#01579b",fontWeight:700}}>🛡️ EMERGENCY</div><div style={{fontSize:16,fontWeight:800,color:C.b}}>{fD(b.emergFund)}</div><div style={{fontSize:9,color:C.tl}}>Post-tax</div></div>
<div style={{textAlign:"center",background:"#f3e5f5",borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#4a148c",fontWeight:700}}>📈 INVESTING</div><div style={{fontSize:16,fontWeight:800,color:"#7b1fa2"}}>{fD(b.investing)}</div><div style={{fontSize:9,color:C.tl}}>Post-tax</div></div>
</div>
...
<div style={{fontSize:11,color:"#78909c",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>💰 Live Paystub Preview</div>
<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:4,fontSize:11}}>
<div style={{color:"#90a4ae"}}>Gross Monthly</div><div style={{textAlign:"right",fontWeight:700}}>{fD(s.gross)}</div>
<div style={{color:"#90a4ae"}}>401(k) ({retPct}%)</div><div style={{textAlign:"right",color:"#66bb6a",fontWeight:700}}>−{fD(s.r4)}</div>
<div style={{color:"#90a4ae"}}>Federal Tax</div><div style={{textAlign:"right",color:"#ef5350"}}>−{fD(s.ft)}</div>
<div style={{color:"#90a4ae"}}>State Tax</div><div style={{textAlign:"right",color:"#ef5350"}}>−{fD(s.st)}</div>
<div style={{color:"#90a4ae"}}>SS + Medicare</div><div style={{textAlign:"right",color:"#ef5350"}}>−{fD(s.ss+s.mc)}</div>
<div style={{color:"#90a4ae"}}>Health Insurance</div><div style={{textAlign:"right",color:"#ef5350"}}>−{fD(s.hi)}</div>
...
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} disabled={rm<0} style={{...bp,opacity:rm<0?.4:1}}>Lock Budget →</button></div></Ph>}
...
{step===0&&<Fd><div style={{background:C.card,borderRadius:14,padding:22,border:`1px solid ${C.br}`,textAlign:"center",marginBottom:18}}><div style={{fontSize:44,marginBottom:10}}>🏠</div><h3 style={{fontFamily:F.d,color:C.dk,margin:"0 0 6px",fontSize:18}}>Buy a house?</h3><p style={{color:C.tl,fontSize:13,marginBottom:16}}>Builds equity but adds mortgage, taxes, insurance, maintenance.</p><div style={{display:"flex",gap:10,justifyContent:"center"}}><button onClick={()=>{sWH("y");sS(1)}} style={{...bp,padding:"12px 28px"}}>🏡 Yes</button><button onClick={()=>{sWH("n");sS(1)}} style={{...bs,padding:"12px 28px"}}>🏢 Rent</button></div></div></Fd>}
{step===1&&<Fd><div style={{background:C.card,borderRadius:14,padding:22,border:`1px solid ${C.br}`,textAlign:"center",marginBottom:18}}><div style={{fontSize:44,marginBottom:10}}>💍</div><h3 style={{fontFamily:F.d,color:C.dk,margin:"0 0 6px",fontSize:18}}>Get married?</h3><p style={{color:C.tl,fontSize:13,marginBottom:16}}>Dual income helps, but adds wedding costs and shared obligations.</p><div style={{display:"flex",gap:10,justifyContent:"center"}}><button onClick={()=>{sWM("y");sS(2)}} style={{...bp,padding:"12px 28px"}}>💍 Yes</button><button onClick={()=>{sWM("n");sS(2)}} style={{...bs,padding:"12px 28px"}}>🚶 Single</button></div></div></Fd>}
{step===2&&<Fd><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}><div style={{background:C.card,borderRadius:12,padding:14,border:`1px solid ${C.br}`,textAlign:"center"}}><div style={{fontSize:28}}>🏠</div><div style={{fontWeight:700,color:C.dk,marginTop:3,fontSize:13}}>{wH==="y"?"Buying ✅":"Renting"}</div></div><div style={{background:C.card,borderRadius:12,padding:14,border:`1px solid ${C.br}`,textAlign:"center"}}><div style={{fontSize:28}}>💍</div><div style={{fontWeight:700,color:C.dk,marginTop:3,fontSize:13}}>{wM==="y"?"Married ✅":"Single"}</div></div></div>{wM==="y"&&<IB c="g" icon="💰" title="Dual Income">Partner est. 75% of salary: +{fmt(Math.round(pd.salary*.75))}/yr.</IB>}<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} style={bp}>Continue →</button></div></Fd>}</Ph>}
...
return<Ph title="🚗 Auto Insurance" sub="Kentucky requires at least liability insurance to drive.">
...
{[
{v:"full",l:"🛡️ Full Coverage",d:"Covers your car + others. Best protection.",price:"~$140/mo base",c:C.g},
{v:"liability",l:"⚖️ Liability Only",d:"Covers others only. Your car is unprotected.",price:"~$55/mo",c:"#f9a825"},
{v:"none",l:"❌ No Insurance",d:"Illegal in KY! Huge risk.",price:"$0/mo",c:C.r}
...
<IB c="b" icon="💡" title="How Deductibles Work">If you have a $1,000 deductible and cause $4,000 in damage: you pay $1,000, insurance pays $3,000. Lower deductible = higher monthly cost but less out-of-pocket when something happens.</IB>
</div>}

{carIns==="liability"&&<IB c="y" icon="⚠️" title="Liability Only">If YOUR car is damaged in an accident, you pay 100% out of pocket. This only covers the other person's car and medical bills.</IB>}
{carIns==="none"&&<IB c="r" icon="🚨" title="Illegal!">Driving without insurance in KY can result in fines up to $1,000, license suspension, and you're liable for ALL damages in an accident.</IB>}
...
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} style={bp}>Lock Insurance →</button></div>
</div></Ph>}
// PHASE: Budget2 — Updated budget after housing & insurance decisions
...
const cats=[
...(mortPay>0?[]:[{k:"housing",l:"🏠 Rent",r:"~28%",c:"#1565c0"}]),
{k:"food",l:"🍎 Food",r:"$300-500",c:"#f9a825"},
{k:"transport",l:"🚗 Transport",r:"$200-400",c:"#6a1b9a"},
{k:"util",l:"💡 Utilities",r:"$100-200",c:"#00838f"},
{k:"phone",l:"📱 Phone",r:"$60-100",c:"#c2185b"},
...
return<Ph title="📋 Updated Budget" sub={`Now with ${mortPay>0?"mortgage":"rent"}, insurance, and all costs factored in.`}>

<IB c="b" icon="📢" title="What Changed">Your budget now includes {mortPay>0?"your mortgage payment":"your rent"}, car insurance{homeIns>0?", homeowner's insurance":""}, and all choices you've made. Time to re-balance!</IB>

<div style={{background:"#f8f7f4",borderRadius:12,padding:14,marginBottom:14,border:`1px solid ${C.br}`}}>
<div style={{fontSize:12,fontWeight:700,color:C.dk,marginBottom:8}}>📌 Fixed Monthly Costs (auto-deducted from take-home)</div>
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(160px,1fr))",gap:8}}>
{lp>0&&<div style={{background:C.card,borderRadius:8,padding:10,border:`1px solid ${C.br}`}}><div style={{fontSize:10,color:C.tl}}>🎓 Student Loan</div><div style={{fontSize:15,fontWeight:800,color:C.r}}>{fD(lp)}</div></div>}
{mortPay>0&&<div style={{background:C.card,borderRadius:8,padding:10,border:`1px solid ${C.br}`}}><div style={{fontSize:10,color:C.tl}}>🏠 Mortgage + Tax + PMI</div><div style={{fontSize:15,fontWeight:800,color:"#1565c0"}}>{fD(mortPay)}</div></div>}
{carIns>0&&<div style={{background:C.card,borderRadius:8,padding:10,border:`1px solid ${C.br}`}}><div style={{fontSize:10,color:C.tl}}>🚗 Car Insurance</div><div style={{fontSize:15,fontWeight:800,color:"#6a1b9a"}}>{fD(carIns)}</div></div>}
{homeIns>0&&<div style={{background:C.card,borderRadius:8,padding:10,border:`1px solid ${C.br}`}}><div style={{fontSize:10,color:C.tl}}>🏠 Home Insurance</div><div style={{fontSize:15,fontWeight:800,color:"#00838f"}}>{fD(homeIns)}</div></div>}
<div style={{background:C.dk,borderRadius:8,padding:10}}><div style={{fontSize:10,color:"#90a4ae"}}>💰 Take-Home Pay</div><div style={{fontSize:15,fontWeight:800,color:"#66bb6a"}}>{fD(tk)}</div></div>
<div style={{background:C.dk,borderRadius:8,padding:10}}><div style={{fontSize:10,color:"#90a4ae"}}>📊 After Fixed Costs</div><div style={{fontSize:15,fontWeight:800,color:"#fbbf24"}}>{fD(af)}</div></div>
</div></div>
...
<div style={{background:rm>=0?C.gl:C.rl,borderRadius:12,padding:14,border:`2px solid ${rm>=0?"#66bb6a":"#ef5350"}`,marginBottom:14,textAlign:"center"}}><div style={{fontSize:11,color:C.tl}}>Remaining</div><div style={{fontSize:28,fontWeight:800,color:rm>=0?C.g:C.r,fontFamily:F.d}}>{fD(rm)}</div>{rm<0&&<div style={{color:C.r,fontSize:11}}>⚠️ Over budget! Reduce spending.</div>}{rm>0&&<div style={{color:C.g,fontSize:11}}>💡 Extra goes to savings</div>}</div>

<div style={{background:"#f8f7f4",borderRadius:14,padding:14,marginBottom:14,border:`1px solid ${C.br}`}}>
<div style={{fontSize:12,fontWeight:700,color:C.dk,marginBottom:8}}>📊 Monthly Savings Breakdown</div>
<div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
<div style={{textAlign:"center",background:C.gl,borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#1b5e20",fontWeight:700}}>🏦 RETIREMENT</div><div style={{fontSize:16,fontWeight:800,color:C.g}}>{fD(s.r4)}</div><div style={{fontSize:9,color:C.tl}}>Pre-tax {retPct}%</div></div>
<div style={{textAlign:"center",background:C.bl,borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#01579b",fontWeight:700}}>🛡️ EMERGENCY</div><div style={{fontSize:16,fontWeight:800,color:C.b}}>{fD(b.emergFund)}</div><div style={{fontSize:9,color:C.tl}}>Post-tax</div></div>
<div style={{textAlign:"center",background:"#f3e5f5",borderRadius:10,padding:10}}><div style={{fontSize:9,color:"#4a148c",fontWeight:700}}>📈 INVESTING</div><div style={{fontSize:16,fontWeight:800,color:"#7b1fa2"}}>{fD(b.investing)}</div><div style={{fontSize:9,color:C.tl}}>Post-tax</div></div>
...
<div style={{color:"#90a4ae"}}>Health Insurance</div><div style={{textAlign:"right",color:"#ef5350"}}>−{fD(s.hi)}</div>
<div style={{borderTop:"1px solid #455a64",paddingTop:4,color:"#66bb6a",fontWeight:800}}>Take-Home</div><div style={{borderTop:"1px solid #455a64",paddingTop:4,textAlign:"right",color:"#66bb6a",fontWeight:800,fontSize:14}}>{fD(s.net)}</div>
<div style={{color:"#fbbf24"}}>Fixed Costs</div><div style={{textAlign:"right",color:"#fbbf24",fontWeight:700}}>−{fD(fixed)}</div>
...
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} disabled={rm<0} style={{...bp,opacity:rm<0?.4:1}}>Lock Final Budget →</button></div></Ph>}
// PHASE: Housing — home insurance included, car insurance handled separately
...
return<Ph title="🏠 Home Buying" sub="Find a home near Erlanger, KY.">
{step===0&&<Fd><p style={{color:C.tl,fontSize:13,marginBottom:10}}>Choose neighborhood (within 10 mi of Erlanger):</p>
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:9,marginBottom:12}}>{HOODS.map(n=>{const s=hood===n.n;return<button key={n.n} onClick={()=>sH(n.n)} style={{padding:11,borderRadius:11,border:s?`3px solid ${C.g}`:`2px solid ${C.br}`,background:s?C.gl:C.card,cursor:"pointer",textAlign:"left",fontFamily:F.b}}><div style={{display:"flex",justifyContent:"space-between"}}><strong style={{fontSize:12,color:C.dk}}>{n.n}</strong><Tg c={C.b} l={n.dist}/></div><div style={{fontSize:10,color:C.tl,marginTop:1}}>{n.d}</div><div style={{fontSize:9,color:C.m,marginTop:1}}>Tax: {(n.tx*100).toFixed(2)}% | HOA: {n.hoa?`$${n.hoa}`:"-"}</div><div style={{fontSize:10,color:C.g,fontWeight:700,marginTop:1}}>{fmt(n.sm)} – {fmt(n.lg)}</div></button>})}</div>
{hood&&<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={()=>sS(1)} style={bp}>Size →</button></div>}</Fd>}

{step===1&&<Fd><h3 style={{fontFamily:F.b,color:C.dk,margin:"0 0 10px",fontSize:15}}>Home size in {hood}:</h3>
<div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,marginBottom:16}}>{[{k:"sm",l:"🏡 Starter",d:"2-3 bed"},{k:"md",l:"🏠 Mid-Size",d:"3-4 bed"},{k:"lg",l:"🏰 Large",d:"4-5 bed"}].map(o=>{const s=size===o.k;return<button key={o.k} onClick={()=>sSz(o.k)} style={{padding:16,borderRadius:12,border:s?`3px solid ${C.g}`:`2px solid ${C.br}`,background:s?C.gl:C.card,cursor:"pointer",textAlign:"center",fontFamily:F.b}}><div style={{fontSize:12,fontWeight:700,color:C.dk}}>{o.l}</div><div style={{fontSize:10,color:C.tl}}>{o.d}</div><div style={{fontSize:18,fontWeight:800,color:C.g,marginTop:6}}>{fmt(hd[o.k])}</div></button>})}</div>
{size&&<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={()=>sS(2)} style={bp}>Mortgage →</button></div>}</Fd>}

{step===2&&<Fd>
<div style={{background:C.dk,borderRadius:18,padding:18,color:"#f1f5f9",marginBottom:14}}>
<h3 style={{fontFamily:F.d,margin:"0 0 12px",fontSize:16}}>🏦 Mortgage Calculator</h3>
...
<div><div style={{fontSize:8,color:"#78909c"}}>HOA</div><div style={{fontSize:15,fontWeight:800}}>{hoa?fD(hoa):"—"}</div></div>
<div><div style={{fontSize:8,color:"#78909c"}}>PMI{dp<20?" ⚠️":""}</div><div style={{fontSize:15,fontWeight:800,color:pmi?"#ef5350":"#66bb6a"}}>{pmi?fD(pmi):"✓"}</div></div></div>
...
<button onClick={()=>sHI("y")} style={{...(homeIns==="y"?bp:bs),padding:"8px 20px",fontSize:12}}>✅ Yes, protect my home</button>
<button onClick={()=>sHI("n")} style={{...(homeIns==="n"?{...bs,borderColor:C.r,color:C.r}:bs),padding:"8px 20px",fontSize:12}}>❌ Skip it</button>
</div>
{homeIns==="n"&&<IB c="r" icon="⚠️" title="Risky!">One storm, fire, or break-in could cost $10,000+. Most mortgage lenders REQUIRE insurance.</IB>}
</div>
...
<div style={{fontSize:10,color:C.tl,marginTop:2}}>{Math.round((totMo/ps(pd.salary).net)*100)}% of take-home{(totMo/ps(pd.salary).net)>.35?<span style={{color:C.r,fontWeight:700}}> ⚠️ Above 35%!</span>:""}</div>
</div>
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} style={bp}>Finalize →</button></div>
</Fd>}</Ph>}
// PHASE: Investing
...
return<Ph title="📈 Investment Strategy" sub={`Allocate your ${fmt(mo)}/mo investment. Total must = 100%.`}>
...
<div style={{background:tot===100?C.gl:C.wl,borderRadius:10,padding:10,textAlign:"center",marginBottom:10,border:`2px solid ${tot===100?"#66bb6a":"#ff9800"}`}}><strong style={{fontSize:14,color:tot===100?C.g:C.w}}>{tot}%{tot===100?" ✅":tot>100?" ⚠️ Over!":""}</strong></div>
{tot===100&&<><button onClick={doSim} style={{...bs,marginBottom:10,fontSize:11}}>🎲 Simulate 5-Year Market</button>
{sim&&<Fd><div style={{background:C.dk,borderRadius:14,padding:14,color:"#f1f5f9",marginBottom:10}}><h4 style={{margin:"0 0 8px",fontFamily:F.b,fontSize:12}}>5-Year Simulation</h4><div style={{display:"flex",gap:6,alignItems:"flex-end",height:80,marginBottom:6}}>{sim.map((y,i)=><div key={i} style={{flex:1,textAlign:"center"}}><div style={{height:`${Math.min(70,(y.bal/(sim[4].bal||1))*70)}px`,background:y.ret>=0?"#66bb6a":"#ef5350",borderRadius:"3px 3px 0 0"}}/><div style={{fontSize:8,color:"#90a4ae",marginTop:1}}>Y{y.y}</div><div style={{fontSize:8,color:"#66bb6a",fontWeight:700}}>{fmt(Math.round(y.bal))}</div></div>)}</div><div style={{fontSize:9,color:"#90a4ae"}}>Put in: {fmt(mo*60)} → Got: {fmt(Math.round(sim[4]?.bal||0))}</div></div>
<IB c="g" icon="🌱" title="Key Lesson"><strong>Time in the market beats timing the market.</strong> Stay invested through ups and downs.</IB></Fd>}</>}
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={go} disabled={tot!==100} style={{...bp,opacity:tot===100?1:.4}}>Lock Strategy →</button></div></Ph>}
...
useEffect(()=>{const pool=[...(pd.teacherEvents||[])];const n=[...LEP.neg],p=[...LEP.pos],u=[...LEP.neu];for(let i=0;i<2;i++)pool.push(n.splice(Math.floor(Math.random()*n.length),1)[0]);pool.push(p[Math.floor(Math.random()*p.length)]);pool.push(u[Math.floor(Math.random()*u.length)]);if(!pd.hasHomeIns&&pd.wantsHouse)pool.push({t:"Storm damage — uninsured!",a:-6000});if(pd.carInsType==="none")pool.push({t:"Fender bender — no insurance!",a:-4000});for(let i=pool.length-1;i>0;i--){const j=Math.floor(Math.random()*(i+1));[pool[i],pool[j]]=[pool[j],pool[i]]}sE(pool);sC(pool[0])},[]);
...
<div style={{background:`linear-gradient(135deg,${C.dk},${C.dk2})`,borderRadius:18,padding:28,textAlign:"center",color:"#f1f5f9",marginBottom:12,minHeight:140,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>{!show?<><div style={{fontSize:44}}>🎲</div><div style={{fontSize:12,color:"#90a4ae",margin:"8px 0"}}>Something happened...</div><button onClick={reveal} style={{...bp,background:"linear-gradient(135deg,#fbbf24,#f59e0b)",color:C.dk}}>Reveal</button></>:<Fd><div style={{fontSize:38}}>{(cur.a||0)>0?"🎉":cur.a<-3000?"😰":"😅"}</div><div style={{fontSize:16,fontWeight:700,margin:"5px 0"}}>{cur.t}</div><div style={{fontSize:22,fontWeight:800,color:(cur.a||0)>0?"#66bb6a":"#ef5350",fontFamily:F.d}}>{cur.a>0?"+":""}{fmt(cur.a)}</div>{sav<0&&<div style={{color:"#fbbf24",fontSize:10,marginTop:6,background:"#3e2723",padding:"4px 10px",borderRadius:6}}>⚠️ Credit card at 24% APR!</div>}<button onClick={next} style={{...bp,marginTop:10}}>{idx+1<evts.length?"Next →":"Results →"}</button></Fd>}</div></Ph>}

// PHASE: Retirement — uses retPct from budget
...
return<Ph title="🏖️ Retirement" sub={`${yrs} years until retirement at 65. Currently age ${ageNow}.`}>
<div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(175px,1fr))",gap:10,marginBottom:16}}>
<SC icon="🏦" label="401(k)" value={fmt(Math.round(r401))} sub={`${fD(mo401)}/mo + ${fmt(Math.round(already401))} banked`} vc={C.g}/>
<SC icon="📈" label="Investments" value={fmt(Math.round(rInv))} sub={`${fmt(moInv)}/mo + ${fmt(Math.round(alreadyInv))} banked`} vc={C.b}/>
{boost>0&&<SC icon="🎁" label="Teacher Bonus" value={fmt(boost)} sub="Added to accounts" vc="#7b1fa2"/>}
<SC icon="🪺" label="Nest Egg" value={fmt(Math.round(nest))} sub="Total savings" vc={C.g}/>
<SC icon="🏛️" label="Social Security" value={fD(ssMo)+"/mo"} sub="Est. benefit"/>
<SC icon="💵" label="Retirement Income" value={fD(retMo)+"/mo"} sub="4% rule + SS" vc={ok?C.g:C.r}/></div>
<div style={{background:C.dk,borderRadius:18,padding:18,color:"#f1f5f9",marginBottom:14}}>
...
<IB c={ok?"g":"r"} icon={ok?"🎉":"⚠️"} title={ok?"Looking Good!":"Retirement Gap"}>{ok?`${fD(retMo)}/month = comfortable retirement. Smart choices paid off!`:`${fD(retMo)}/month may be tight. Every extra $100/mo now adds ~${fmt(Math.round(100*((Math.pow(1+.08/12,yrs*12)-1)/(.08/12))))} to nest egg.`}</IB>
<div style={{background:C.gl,borderRadius:12,padding:16,border:"2px solid #66bb6a",marginBottom:14}}><strong style={{color:"#1b5e20",fontSize:14}}>📋 Discussion Questions</strong><div style={{fontSize:12,color:"#2e7d32",lineHeight:1.7,marginTop:4}}>1. What surprised you about your paycheck?<br/>2. Would you change your education choice?<br/>3. How would a {fmt(5000)} emergency affect your plan?<br/>4. Why does investing early matter so much?<br/>5. How did housing and insurance affect your monthly budget?<br/>6. How did your retirement savings % impact your nest egg?<br/>7. What's the trade-off between higher deductible and lower insurance premium?</div></div>
<div style={{display:"flex",justifyContent:"flex-end"}}><button onClick={onDone} style={bp}>Final Summary →</button></div></Ph>}
// PHASE: Summary
...
<SC icon="🎓" label="Education" value={ep?.t||"N/A"} sub={`Debt: ${fmt(pd.debt||0)}`}/>
<SC icon="💼" label="Career" value={pd.career||"N/A"} sub={`${fmt(pd.salary||0)}/yr`}/>
<SC icon="💵" label="Take-Home" value={fD(s.net)} sub="Per month"/>
<SC icon="🏦" label="401(k)" value={`${Math.round((pd.retPct||.06)*100)}%`} sub={`${fD(s.r4)}/mo pre-tax`} vc={C.g}/>
{pd.wantsHouse&&<SC icon="🏠" label="Home" value={fmt(pd.homePrice||0)} sub={`${pd.neighborhood||""} ${fD(pd.mortPay||0)}/mo`}/>}
<SC icon="🚗" label="Car Insurance" value={pd.carInsType==="full"?`Full (${fmt(pd.carDeductible||1000)} ded)`:pd.carInsType==="liability"?"Liability":"None!"} sub={`${fD(pd.carInsMo||0)}/mo`}/>
<SC icon="📈" label="Investing" value={`${fmt(pd.monthlyInv||0)}/mo`}/>
<SC icon="🛡️" label="Emergency" value={fmt(Math.max(0,pd.emergFund||0))} sub={(pd.emergFund||0)<0?"⚠️ Debt":"Saved"}/>
<SC icon="💳" label="Credit" value={cs} sub={cs>=740?"Excellent":cs>=670?"Good":"Needs Work"} vc={cc}/>
{pd.wantsMarriage&&<SC icon="💍" label="Married" value="Yes" sub={`+${fmt(pd.dualIncome||0)}/yr`}/>}
</div>
<div style={{display:"flex",gap:8,justifyContent:"center",flexWrap:"wrap"}}><button onClick={onRestart} style={bp}>🔄 Play Again</button><button onClick={onTeacher} style={bs}>🍎 Teacher</button></div></Ph>}
...
<button onClick={tryAuth} style={{...bp,width:"100%",marginTop:10,padding:"12px",fontSize:14}}>🔑 Sign In</button>
<button onClick={onBack} style={{background:"none",border:"none",color:"#78909c",fontSize:12,cursor:"pointer",fontFamily:F.b,marginTop:12,display:"block",width:"100%",textAlign:"center"}}>← Back to student login</button>
</div></div>}
...
<div style={{display:"flex",gap:5,marginBottom:16,flexWrap:"wrap"}}>{[{id:"unlock",l:"🔓 Unlock"},{id:"boost",l:"⚡ Boost"},{id:"market",l:"📊 Markets"},{id:"students",l:"👨‍🎓 Students"},{id:"events",l:"🎲 Events"}].map(t=><button key={t.id} onClick={()=>sTab(t.id)} style={{padding:"7px 12px",borderRadius:7,border:"none",background:tab===t.id?C.dk:"#e8e6e0",color:tab===t.id?"#fff":C.t,fontWeight:700,fontSize:11,cursor:"pointer",fontFamily:F.b}}>{t.l}</button>)}</div>

{tab==="unlock"&&<div style={{background:"#f8f7f4",borderRadius:14,padding:18}}><h3 style={{fontFamily:F.b,fontSize:15,color:C.dk,margin:"0 0 12px"}}>Pause Point Controls</h3><p style={{fontSize:12,color:C.tl,marginBottom:14}}>Students pause at key sections. Unlock when ready.</p><div style={{display:"grid",gap:8}}>{lkk.map((k,i)=><div key={k} style={{display:"flex",justifyContent:"space-between",alignItems:"center",background:C.card,borderRadius:10,padding:"12px 16px",border:`1px solid ${C.br}`}}><div><strong style={{fontSize:13,color:C.dk}}>{lkl[i]}</strong><div style={{fontSize:10,color:C.m}}>Pause #{i+1}</div></div><button onClick={()=>setLocks(p=>({...p,[k]:!p[k]}))} style={{...(locks[k]?{...bs,borderColor:C.r,color:C.r,fontSize:11,padding:"6px 14px"}:{...bp,fontSize:11,padding:"6px 14px"})}}>{locks[k]?"🔒 Locked":"🔓 Open"}</button></div>)}</div></div>}

{tab==="boost"&&<div style={{background:"#f8f7f4",borderRadius:14,padding:18}}>
<div style={{marginBottom:12}}><label style={{fontSize:12,fontWeight:600,color:C.t,display:"block",marginBottom:3}}>Student</label><select value={sel} onChange={e=>sSel(e.target.value)} style={{width:"100%",padding:"7px 10px",borderRadius:7,border:`2px solid ${C.br}`,fontSize:12,fontFamily:F.b}}><option value="">Choose...</option>{students.map(s=><option key={s.name} value={s.name}>{s.name} — {s.career||"—"} ({fmt(s.salary||0)})</option>)}</select></div>
<div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:12}}>{[{id:"raise",l:"💰 Raise",c:C.g},{id:"credit_up",l:"📈 Credit+",c:C.b},{id:"credit_down",l:"📉 Credit-",c:C.r},{id:"money",l:"🏦 Add $",c:"#7b1fa2"},{id:"event",l:"🎲 Event",c:C.w}].map(a=><button key={a.id} onClick={()=>sBT(a.id)} style={{padding:"5px 10px",borderRadius:6,border:bType===a.id?`2px solid ${a.c}`:`1px solid ${C.br}`,background:bType===a.id?`${a.c}15`:C.card,color:a.c,fontWeight:700,fontSize:10,cursor:"pointer",fontFamily:F.b}}>{a.l}</button>)}</div>
...
<div style={{display:"flex",gap:6}}><button onClick={()=>apply(sel)} disabled={!sel} style={{...bp,opacity:sel?1:.4,fontSize:11,padding:"8px 16px"}}>Apply to {sel||"—"}</button><button onClick={()=>apply("all")} disabled={!students.length} style={{...bs,fontSize:11,padding:"8px 16px"}}>Apply All</button></div></div>}

{tab==="market"&&<div style={{background:"#f8f7f4",borderRadius:14,padding:18}}>
<h3 style={{fontFamily:F.b,fontSize:15,color:C.dk,margin:"0 0 12px"}}>📊 Market & Rate Controls</h3>
...
{tab==="students"&&<div>{students.length===0?<div style={{textAlign:"center",padding:30,color:C.m}}>📋 No students yet.</div>:<div style={{display:"grid",gap:8}}>{students.map((s,i)=><div key={i} style={{background:"#f8f7f4",borderRadius:12,padding:12,border:`1px solid ${C.br}`}}><div style={{display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:4}}><div><strong style={{fontSize:14,color:C.dk}}>{s.name}</strong><div style={{fontSize:11,color:C.tl}}>{s.career||"—"} • {fmt(s.salary||0)}/yr • Credit: {s.creditScore||700}{s.carInsType?` • Car: ${s.carInsType}`:""}</div></div>{s.edPath&&<Tg c={C.b} l={EP.find(p=>p.id===s.edPath)?.t||""}/>}</div>{s.teacherBoosts?.length>0&&<div style={{marginTop:4,display:"flex",gap:2,flexWrap:"wrap"}}>{s.teacherBoosts.map((b,j)=><span key={j} style={{fontSize:9,background:"#bbdefb",color:"#0d47a1",padding:"1px 5px",borderRadius:3}}>{b}</span>)}</div>}</div>)}</div>}</div>}

{tab==="events"&&<div style={{background:"#f8f7f4",borderRadius:14,padding:18}}><h3 style={{fontFamily:F.b,fontSize:14,color:C.dk,margin:"0 0 10px"}}>Quick Templates</h3><div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:7}}>{[{t:"🏠 Roof emergency!",a:-4500},{t:"🚗 Car accident!",a:-2800},{t:"💰 Performance bonus!",a:3000},{t:"📈 Promotion!",a:8000},{t:"🏥 Medical bill",a:-2000},{t:"🎓 Tuition help",a:5000}].map((ev,i)=><button key={i} onClick={()=>{sBT("event");sET(ev.t);sEA(ev.a);sTab("boost")}} style={{padding:10,borderRadius:10,border:`1px solid ${C.br}`,background:C.card,cursor:"pointer",textAlign:"left",fontFamily:F.b}}><div style={{fontSize:12,fontWeight:700,color:C.dk}}>{ev.t}</div><div style={{fontSize:11,color:ev.a>0?C.g:C.r,fontWeight:700}}>{ev.a>0?"+":""}{fmt(ev.a)}</div></button>)}</div></div>}

<div style={{marginTop:20,display:"flex",justifyContent:"center"}}><button onClick={onBack} style={bs}>← Sign Out</button></div></Ph>}
async function saveStudent(pd){try{localStorage.setItem(`student:${pd.name}`,JSON.stringify(pd));const idx=JSON.parse(localStorage.getItem("student:_index")||"[]");if(!idx.includes(pd.name)){idx.push(pd.name);localStorage.setItem("student:_index",JSON.stringify(idx))}}catch(e){}}
async function loadStudent(name){try{const r=localStorage.getItem(`student:${name}`);return r?JSON.parse(r):null}catch(e){return null}}
async function loadAllStudents(){try{const idx=JSON.parse(localStorage.getItem("student:_index")||"[]");const out=[];for(const n of idx){const r=localStorage.getItem(`student:${n}`);if(r)out.push(JSON.parse(r))}return out}catch(e){return[]}}
async function saveLocks(lk){try{localStorage.setItem("teacher:locks",JSON.stringify(lk))}catch(e){}}
async function loadLocks(){try{const r=localStorage.getItem("teacher:locks");return r?JSON.parse(r):null}catch(e){return null}}
...
<button onClick={tryLogin} disabled={loading} style={{...bp,width:"100%",marginTop:14,padding:"13px",fontSize:15,opacity:loading?.6:1}}>{loading?"Loading...":"🎮 Sign In & Play"}</button>
<div style={{borderTop:"1px solid rgba(255,255,255,.1)",marginTop:18,paddingTop:14,textAlign:"center"}}><button onClick={onTeacher} style={{background:"none",border:"none",color:"#80cbc4",fontSize:13,cursor:"pointer",fontFamily:F.b,fontWeight:600}}>🍎 Teacher Dashboard →</button></div>
</div>
:<div style={{background:"rgba(255,255,255,.06)",borderRadius:16,padding:28,width:"100%",maxWidth:420}}>
<div style={{textAlign:"center",marginBottom:16}}><div style={{fontSize:40,marginBottom:8}}>👋</div><h3 style={{fontFamily:F.d,color:"#e8f5e9",margin:"0 0 4px",fontSize:20}}>Welcome back, {returning.name}!</h3><p style={{color:"#80cbc4",fontSize:13}}>Saved progress found.</p></div>
...
{returning.career&&<div>💼 {returning.career}</div>}
{returning.salary>0&&<div>💰 {fmt(returning.salary)}/yr</div>}
{returning.edPath&&<div>🎓 {EP.find(p=>p.id===returning.edPath)?.t}</div>}
{returning.phase&&<div>📍 {returning.phase}</div>}
</div></div>
<div style={{display:"flex",gap:10,flexDirection:"column"}}><button onClick={()=>onLogin(returning.name,returning)} style={{...bp,width:"100%",padding:"12px",fontSize:14}}>▶️ Continue</button><button onClick={()=>onLogin(name.trim(),null)} style={{...bs,width:"100%",padding:"12px",fontSize:13,background:"rgba(255,255,255,.06)",color:"#a5d6a7",borderColor:"rgba(255,255,255,.15)"}}>🔄 Start Over</button><button onClick={()=>sR(null)} style={{background:"none",border:"none",color:"#78909c",fontSize:12,cursor:"pointer",fontFamily:F.b,marginTop:4}}>← Different name</button></div>
</div>}
</div>}
...
useEffect(()=>{(async()=>{const lk=await loadLocks();if(lk)sLk(lk);const st=await loadAllStudents();if(st.length)sSt(st);sReady(true)})()},[]);
useEffect(()=>{if(ready)saveLocks(locks)},[locks,ready]);
useEffect(()=>{if(phase!=="login"&&phase!=="welcome"&&phase!=="teacher"&&phase!=="teacherLogin"){sPd(d=>{if(d.phase!==phase){const u={...d,phase};if(d.name&&ready)saveStudent(u);return u}return d})}if(pd.name&&phase!=="login"&&phase!=="welcome"&&phase!=="teacher"&&phase!=="teacherLogin"&&ready){saveStudent({...pd,phase});sSt(p=>{const e=p.find(s=>s.name===pd.name);return e?p.map(s=>s.name===pd.name?{...pd,phase}:s):[...p,{...pd,phase}]})}},[phase,ready]);
...
useEffect(()=>{if(!phase.startsWith("pause"))return;const iv=setInterval(async()=>{const lk=await loadLocks();if(lk)sLk(lk)},3000);return()=>clearInterval(iv)},[phase]);
...
const pauseInfo={pause1:{t:"Education Complete",m:"Wait for teacher to discuss choices.",nx:"career"},pause2:{t:"Budget Complete",m:"Teacher will review outcomes.",nx:"lifeChoices"},pause3:{t:"Housing Complete",m:"Discuss housing impact on wealth.",nx:"investing"},pause4:{t:"Investing Complete",m:"Discuss allocations & market impact.",nx:"lifeEvents"}};

if(!ready)return<div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0a0e27",color:"#80cbc4",fontFamily:F.b}}>Loading...</div>;
...
if(isPause)return<div style={{minHeight:"100vh",background:C.bg,fontFamily:F.b}}><link href={FL} rel="stylesheet"/><div style={{background:C.card,borderBottom:`1px solid ${C.br}`,padding:"10px 18px",display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:50}}><div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:18}}>💸</span><strong style={{color:C.dk,fontSize:14}}>Life & Money</strong>{pd.name&&<span style={{color:C.tl,fontSize:12}}>• {pd.name} (Age {pd.age||18})</span>}</div><button onClick={()=>sP("login")} style={{fontSize:11,background:"none",border:`1px solid ${C.br}`,borderRadius:6,padding:"4px 10px",cursor:"pointer",color:C.tl,fontFamily:F.b}}>🚪</button></div><PauseScreen title={isPause.t} msg={isPause.m} onCont={()=>go(isPause.nx)} locked={locks[phase]} era={eraMap[phase]} pd={pd} onUpdatePd={sPd}/></div>;
const gp=PHASES.filter(p=>!p.startsWith("pause")&&p!=="welcome"&&p!=="teacher"&&p!=="login");
...
<div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:18}}>💸</span><strong style={{color:C.dk,fontSize:14}}>Life & Money</strong>{pd.name&&<span style={{color:C.tl,fontSize:12}}>• {pd.name} (Age {pd.age||18})</span>}</div>
<div style={{display:"flex",gap:6}}>{pd.name&&<><span style={{fontSize:10,color:C.tl,padding:"4px 8px",background:"#f8f7f4",borderRadius:6}}>💳 {pd.creditScore||700}</span><span style={{fontSize:10,color:C.tl,padding:"4px 8px",background:"#f8f7f4",borderRadius:6}}>🎂 {pd.age||18}</span></>}<button onClick={()=>sP("login")} style={{fontSize:11,background:"none",border:`1px solid ${C.br}`,borderRadius:6,padding:"4px 10px",cursor:"pointer",color:C.tl,fontFamily:F.b}}>🚪</button></div></div>
